// ABOUTME: Shared SVG icon components for consistent iconography across the application
// ABOUTME: Centralized icon definitions to prevent duplication and ensure design consistency
...
// Heart Icon with filled state support
interface HeartIconProps extends IconProps {
  filled?: boolean;
}

export const HeartIcon: React.FC<HeartIconProps> = ({ className = '', size = 24, filled = false }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
...
// Theme Icons (already exist in ThemeToggle but can be centralized later)
...
export const SystemIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
