...
// Sidebar component function definition
function Sidebar() {
  // Accessing global state using custom hook
  const { theme, collapsed, collapseMenu } = useGlobalState();
  // Accessing Clerk authentication functions and user data
  ...
  // Initializing router and pathname hooks
  ...
  return (
    <SidebarStyled theme={theme} collapsed={collapsed}>
      ...
      <div className="profile">
        ...
        {/* Clerk UserButton component for user authentication */}
      ...
      <ul className="nav-items">
        {/* Mapping through menu items and rendering navigation links */}
        {menu.map((item) => {
      ...
      <div className="sign-out relative m-6">
        <Button
          ...
          icon={logout}
          click={() => {
            // Signing out user and redirecting to signin page
